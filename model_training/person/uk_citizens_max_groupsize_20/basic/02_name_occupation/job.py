...
model_path = paths["training_models_path"].replace(
    "02_name_occupation", "00_estimate_u"
)
...
settings_obj.settings_dict["blocking_rules"] = [
    "l.forename1_std = r.forename1_std and l.surname_std = r.surname_std and l.occupation = r.occupation",
]

settings_obj.remove_comparison_column("forename1_std")
settings_obj.remove_comparison_column("surname_std")
settings_obj.remove_comparison_column("occupation")
...
chart_name = "final_splink_charts_01_surname_block.html"
