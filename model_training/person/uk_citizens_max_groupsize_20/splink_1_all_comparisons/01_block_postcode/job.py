...
model_path = paths["training_models_path"].replace("01_block_postcode", "00_estimate_u")
...
custom_log.info(f"Before linker initialised")
linker = Splink(
...
custom_log.info(f"After linker initialised")
linker.df.persist()
...
chart_name = "final_splink_charts_01_postcode_block.html"
